        ...
        for patch_name, patch in meshSettings.geometry.items():
            if patch.purpose != 'refinementRegion' and patch.purpose != 'refinementSurface':
                ...
                if patch.property == None:
                    ...
                    property = "None"
                ampersandIO.printMessage(f"{i:<5}{patch_name:<20}{
                                         patch.purpose:<20}{property:<15}")
                i += 1
...
if __name__ == "__main__":
    print(DictGenerationUtils.createFoamHeader(
        className="dictionary", objectName="snappyHexMeshDict")
    )
    print(DictGenerationUtils.createDimensions(M=1, L=1, T=1))
    print(DictGenerationUtils.createScalarFixedValue(patch_name="inlet", value=0))
    print(DictGenerationUtils.createScalarZeroGradient(patch_name="inlet"))
    print(DictGenerationUtils.createVectorFixedValue(
