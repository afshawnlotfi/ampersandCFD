...
from constants import BoundaryConditions, InletValues, MeshSettings, meshSettings, boundaryConditions
...
def create_p_file(meshSettings: MeshSettings, boundaryConditions: BoundaryConditions):
    ...
    dims = DictGenerationUtils.createDimensions(M=0, L=2, T=-2)
...
def create_omega_file(meshSettings: MeshSettings, boundaryConditions: BoundaryConditions, nu=1.0e-5):
    ...
    dims = DictGenerationUtils.createDimensions(M=0, L=0, T=-1)
    internalField = DictGenerationUtils.createInternalFieldScalar(
        type="uniform", value=1.0e-6)
...
def create_epsilon_file(meshSettings: MeshSettings, boundaryConditions: BoundaryConditions, nu=1.0e-5):
    ...
    dims = DictGenerationUtils.createDimensions(M=0, L=2, T=-3)
    internalField = DictGenerationUtils.createInternalFieldScalar(
        type="uniform", value=1.0e-6)
