from ampersand.primitives import AmpersandDataInput, AmpersandIO
...
class ProjectIOUtils:
    ...
    #     ProjectIOUtils.assign_transient(project)
    #     if self.transient:
    ...
    @staticmethod
    def assign_transient(project: AmpersandProject):
        is_transient = AmpersandIO.get_input("Transient or Steady State (T/S)?: ").lower() == 't'    
        project.settings.control.transient = is_transient

    # choose turbulence model for the simulation
    @staticmethod
    def assign_turbulence_model(project: AmpersandProject):
        ...
        project.settings.physicalProperties.turbulenceModel = turbulence_model # type: ignore
