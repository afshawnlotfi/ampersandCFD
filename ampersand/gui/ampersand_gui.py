...
from ampersand.gui.dialogBoxes import sphereDialogDriver, yesNoDialogDriver, yesNoCancelDialogDriver
# ----------------- VTK Libraries ----------------- #
import vtk
...
#----------------- Event Handlers -----------------#
    ...
    def createCase(self):
        ...
        self.project.set_project_directory(AmpersandUtils.ask_for_directory(qt=True))
    ...
    def openCase(self):
        ...
        # clear the list widget
        self.window.listWidgetObjList.clear()
        projectFound = self.project.set_project_path(AmpersandUtils.ask_for_directory(qt=True))
